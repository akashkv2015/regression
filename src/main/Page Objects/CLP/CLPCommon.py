...
img_hero_banner = '//*[@id="hero_responsiveCP"]'

img_innovation_banner = '//div[@class="LTinnovationSep18"]'
###For the shop link in innovation banner

shop_link_innovation = "//div[@class='LTinnovationSep18']//a[contains(text(),'SHOP')]"
