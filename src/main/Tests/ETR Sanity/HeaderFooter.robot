...
#        ...     cvvLocator=${txt_cvv}   cvvValue=${cardCVV}     frame=${psg_frame}
    Enter Credit Or Debit Card Details      creditDebitTabLocator=//span[@class='withText']      txtCardLocator=//input[@id="txtCardNumber"]
...
##################### (Private User)   Verify Header Footer links in Homepage Checkout and PGS pages  ########################
...
#    ...     AND     Unselect Frame
    ...
    #7. Click on "CHECKOUT" for registered users
    Wait Until Element Is Visible     //input[@id='logonId']
    Enter Value        //input[@id='logonId']     ${uat_pvt_username}
    Click On Element   //a[@class='bluebtn_login']
    Enter Value        //input[@type='password']    ${uat_pvt_password}
    Click On Element    //button[@type='submit']
    Sleep   3s
...
#    Review And Place Order      reviewOrderLocator=//div[@id='btnReviewOrder']      placeOrderLocator=//div[@id='placeOrderTop']
    Wait Until Element is Visible   //div[@id='placeOrderTop']
    Click On Element      //div[@id='placeOrderTop']
